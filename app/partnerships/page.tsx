...
const PARTNERS = [
  ...
  },
  {
    ...
    description:
      "NDAS secures a four year accreditation from the Federal Ministry of Labour and Employment for the conduct of Trade Test Examination. The approval was a follow up to the visit of Engr Godwin Ugwu to NDAS a few months back.",
    pill: "Trade Test Accreditation",
  },
];
    ...
    <section className="bg-[#f5f7f9] py-28 md:py-36 relative overflow-hidden">
      <div className="max-w-7xl mx-auto px-6 sm:px-10">
        ...
        >
          ...
          >
            NDAS pursues structured partnerships that support practical
            training, certification, dockyard-relevant skill acquisition.
            Partnerships may include active collaborations, developing
            engagements and approved exploratory discussions.
          </motion.p>
        </motion.div>
