    ...
    <section className="bg-[#f5f7f9] py-28 md:py-36 relative overflow-hidden">
      <div className="max-w-7xl mx-auto px-6 sm:px-10">
        ...
        >
          ...
          >
            The School&apos;s facilities should be presented honestly and
            specifically. Their value lies in how they support workshop
            learning, trade practice, safety, and skill development across
            departments.
          </motion.p>
        </motion.div>
        ...
        <div className="flex flex-col lg:flex-row gap-12 lg:gap-16 items-stretch">
          ...
          >
            <SpotlightCard className="h-full bg-white border border-[#0b2748]/5 p-10 md:p-14 rounded-xl">
              ...
              >
                NDAS should not present its facilities as if they are a closed
                campus disconnected from industry. Its real advantage is that
                the School&apos;s workshops exist within the broader environment
                of Naval Dockyard Limited, where technical work, maintenance
