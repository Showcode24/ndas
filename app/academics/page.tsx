...
const TRADES = [
  {
    ...
    description: "Training in metal joining processes, fabrication techniques, cutting methods, and practical repair support.",
    category: "Mechanical",
    ...
    image: (
      <svg viewBox="0 0 800 500" className="absolute inset-0 w-full h-full" preserveAspectRatio="xMidYMid slice">
        ...
        <g opacity=".22" stroke="#315e87" strokeWidth="1">
          {Array.from({length:14},(_,i)=><line key={`v${i}`} x1={i*60} y1="0" x2={i*60} y2="500"/>)}
          {Array.from({length:9},(_,i)=><line key={`h${i}`} x1="0" y1={i*60} x2="800" y2={i*60}/>)}
        </g>
        <circle cx="656" cy="130" r="100" fill="#d4a734" opacity=".14"/>
        <g stroke="#f7fafc" strokeWidth="8" fill="none" opacity=".95">
          <path d="M170 500 C260 410, 360 360, 500 300"/><path d="M500 300 l80 120"/><path d="M610 205 l0 300"/><circle cx="610" cy="170" r="38"/><path d="M610 332 l160 0"/><path d="M770 332 l0 120"/>
        </g>
  ...
  },
  {
    ...
    description: "Training in electrical installation, basic controls, fault diagnosis, and motor rewinding.",
    category: "Electrical",
    ...
    image: (
      <svg viewBox="0 0 800 500" className="absolute inset-0 w-full h-full" preserveAspectRatio="xMidYMid slice">
        ...
        <g opacity=".22" stroke="#315e87" strokeWidth="1">
          {Array.from({length:15},(_,i)=><line key={`v${i}`} x1={i*55} y1="0" x2={i*55} y2="500"/>)}
          {Array.from({length:10},(_,i)=><line key={`h${i}`} x1="0" y1={i*55} x2="800" y2={i*55}/>)}
        </g>
        ...
        <g stroke="#f7fafc" strokeWidth="6" fill="none">
          <path d="M500 230 h160 v80 h120 v90 h120"/><path d="M500 420 h110 v-60 h120 v60 h110"/>
          <circle cx="500" cy="230" r="16" fill="#d4a734"/><circle cx="500" cy="420" r="16" fill="#d4a734"/>
          <circle cx="780" cy="310" r="16" fill="#d4a734"/><circle cx="730" cy="360" r="16" fill="#d4a734"/>
        </g>
  ...
  },
  {
    ...
    description: "Training in pipe systems, fittings, installation methods, and maintenance procedures.",
    category: "Mechanical",
    ...
    image: (
      <svg viewBox="0 0 800 500" className="absolute inset-0 w-full h-full" preserveAspectRatio="xMidYMid slice">
        ...
        <g stroke="#f7fafc" strokeWidth="22" fill="none" strokeLinecap="round" strokeLinejoin="round">
          <path d="M180 180 h240 v120 h120 v180"/><path d="M270 520 v-150 h190 v-110 h240"/><path d="M770 160 v140 h120 v160"/>
        </g>
  ...
  },
  {
    ...
    description: "Training in woodwork, joinery, fitting, structural tasks, and practical workshop operations.",
    ...
    image: (
      <svg viewBox="0 0 800 500" className="absolute inset-0 w-full h-full" preserveAspectRatio="xMidYMid slice">
        ...
        <g fill="none" stroke="#f7fafc" strokeWidth="8">
          <path d="M160 470 l260 -200 l240 0 l190 155 l-250 0 l-170 -140 l-220 185 z"/><path d="M270 470 l170 -140 l160 0 l110 95"/>
          <rect x="650" y="180" width="120" height="160" rx="8"/><path d="M710 160 l0 220"/><path d="M650 240 h120"/>
        </g>
...
const FEATURES = [
  {
    ...
    description: "The School's biggest advantage is that training takes place within the operational environment of Naval Dockyard Limited, not in isolation from it.",
    icon: (
  ...
  },
  {
    ...
    description: "The training model places strong weight on practical work, workshop exposure, and applied learning rather than theory alone.",
    icon: (
      <svg className="w-7 h-7" fill="none" stroke="currentColor" strokeWidth="1.5" viewBox="0 0 24 24">
  ...
  },
  {
    ...
    description: "NDAS is strengthening the formal value of its training through Trade Test, HSE, and other curriculum-linked certification pathways.",
    icon: (
      <svg className="w-7 h-7" fill="none" stroke="currentColor" strokeWidth="1.5" viewBox="0 0 24 24">
              ...
              <Link href={`/academics/${i + 1}`}>
                <div className="relative bg-white border border-[#0b2748]/8 overflow-hidden hover:border-[#af8f47]/30 transition-all duration-500">
                  ...
                  <motion.div
                    ...
                    transition={{ duration: 1.2, delay: 0.2 + i * 0.1, ease: expo }}
                    viewport={{ once: true }}
                  />
