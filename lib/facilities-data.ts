export const facilitiesPageData = {
  hero: {
    ...
    description:
      "NDAS combines dedicated training spaces with the wider practical value of the Naval Dockyard environment.",
    breadcrumbs: "Home / Facilities",
  },

  training_environment: {
    title: "Practical Space Matters in Technical Training.",
    description:
