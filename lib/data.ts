...
export const mockPrograms: Program[] = [
  {
    ...
    description: 'Comprehensive training in marine propulsion systems and naval engineering',
    duration: '4 Years',
    category: 'Marine',
    icon: 'Anchor',
  },
  {
    ...
    description: 'Advanced electrical and electronics installation and maintenance',
    duration: '3 Years',
    category: 'Electrical',
    icon: 'Zap',
  },
  {
    ...
    description: 'Machining, fitting, and mechanical systems engineering',
    duration: '4 Years',
    category: 'Mechanical',
    icon: 'Wrench',
  },
  {
    ...
    description: 'Naval architecture and construction techniques',
    duration: '3 Years',
    category: 'Civil',
    icon: 'Building',
  },
...
export const mockNews: NewsItem[] = [
  {
    ...
    excerpt: 'Recent batch of NDAS graduates recognized in national maritime competition',
  ...
  },
  {
    ...
    excerpt: 'NDAS partners with leading maritime companies for student placements',
    date: new Date('2024-02-28'),
